...
export default function Browser() {
  ...
  return (
    <div className="h-full flex flex-col p-4 font-system select-text" style={{ color: "var(--ink)" }}>
      
      <form onSubmit={handleNavigate} className="flex gap-2 mb-4">
        <div className="flex-1 flex items-center gap-2 border px-3 py-1.5 rounded-lg bg-[var(--paper)]"
      ...
      <div className="flex-1 border border-dashed rounded-xl p-6 flex flex-col items-center justify-center text-center gap-3"
        style={{ borderColor: "var(--border-color)" }}>
        <Globe size={36} className="opacity-40 animate-pulse" />
        <h3 className="text-sm font-bold tracking-wider uppercase">External Web Gateway</h3>
